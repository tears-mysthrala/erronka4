# Zabala Gailetak - Segurtasun Plana

## 1. Testuingurua eta Irismena

Dokumentu honek Zabala Gailetak enpresaren Segurtasun Plana definitzen du.
**Jarduera:** Gailetak eta txokolateak ekoiztea, saltzea eta banatzea.
...
- **ERP:** Ekoizpena, inbentarioa eta finantzak kudeatzeko.
- **Webgunea:** E-commerce plataforma (B2B eta B2C) bezeroen profilekin.
- **Mugikorretako Aplikazioa:** Bezeroentzako app-a.
- **SCADA/HMI:** Fabrikako makineria kontrolatzeko softwarea.
...
- **GDPR:** Bezero eta langileen datuen tratamendua.
- **NIS Zuzentaraua:** Zerbitzu digitalen eta funtsezkoen segurtasuna.
